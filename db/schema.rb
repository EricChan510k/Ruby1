...
ActiveRecord::Schema.define(:version => 20130713084306) do
  ...
  create_table "payments", :force => true do |t|
    ...
    t.string   "refund_id"
    t.integer  "price_subtotal", :default => 0
    t.integer  "price_discount", :default => 0
    t.integer  "price_tax",      :default => 0
    t.integer  "price_refund",   :default => 0
    t.integer  "price_total",    :default => 0
    t.string   "status"
  ...
  create_table "product_specs", :force => true do |t|
    ...
    t.string   "manufacture_city"
    t.string   "manufacture_state"
    t.string   "manufacture_zip"
    t.string   "manufacture_email"
    t.string   "manufacture_phone"
    t.string   "manufacture_website"
    t.string   "name"
    t.text     "description"
